...
<h1>Peta Persebaran Bandar Lampung</h1>
<div class="row">
    <div class="card">
        <div class="card-body">
...
<script>
    ...
    var map = L.map('maps').setView({lat: -5.42297774, lon: 105.28694755}, 12);
    ...
    {
        // "<h4>Jumlah Proyeksi Penduduk Per Kecamatan</h4><br>"+
        layer.bindPopup(feature.properties.NAMOBJ+" : "+feature.properties.nilai );
        layer.on({
    ...
    info.update = function (props) {
        ...
        '<b>' + props.NAMOBJ + '</b><br />' + props.nilai : 
        'Hover diatas wilayah');
    };
    ...
    legend.onAdd = function(map) {
        ...
        grades = [0, (nilaiMax/8) * 1, (nilaiMax/8)*2, (nilaiMax/8)*3, (nilaiMax/8)*4,
                 (nilaiMax/8)*5, (nilaiMax/8)*6, (nilaiMax/8)*7],
                 labels = [];
